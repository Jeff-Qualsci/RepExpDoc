...
4.  Calculate limits of agreement $LSAs = \bar{d}\pm2sd$ Most of the compound differences (\~95%) should fall within these limits.

5.  Samples outside the agreement limits are flagged as outliers.
...
effData <- read_csv(file.path("Data", 'MSD20Data320.csv'), col_types = 'cdd') %>% 
  slice_head(n = 6) %>% 
  gt() %>% 
...
effCalcData <- read_csv(file.path(reports_dir, 'MSD20Data320_EFF_2024-10-28 13_11_21.084501', 'MSD20Data320_EFF_OutputData_tbl.csv'), col_types = 'cddddc') %>% 
  slice_head(n = 6) %>% 
  gt() %>% 
...
![Mean-Difference plot of efficacy data.](Reports/MSD20Data320_EFF_2024-10-28%2013_11_21.084501/MSD20Data320_MSDFig_2024-10-28%2013_11_05.356727.png){#fig-effMDplot}
...
effStats <- read_csv(file.path(reports_dir, 'MSD20Data320_EFF_2024-10-28 13_11_21.084501', 'MSD20Data320_EFF_Stats_tbl.csv'), col_types = 'cdddddd') %>% 
  gt() %>% 
...
![Efficacy Correlation plot.](Reports/MSD20Data320_EFF_2024-10-28%2013_11_21.084501/MSD20Data320_CorrFig_2024-10-28%2013_11_05.357563.png){#fig-effcorrplot}
...
![Mean Difference plot for an assay with 10% CV.](Reports/MSD_320_CV10_EFF_2024-10-28%2013_10_15.440094/MSD_320_CV10_MSDFig_2024-10-28%2013_05_38.837807.png){#fig-effMDcv}
...
effCvStats <- read_csv(file.path(reports_dir, 'MSD_320_CV10_EFF_2024-10-28 13_10_15.440094', 'MSD_320_CV10_EFF_Stats_tbl.csv'), col_types = 'cdddddd') %>% 
  gt() %>% 
  tab_header(title = 'Efficacy Stats') %>% 
  fmt_scientific()
...
![Correlation plot for an assay with 10% CV.](Reports/MSD_320_CV10_EFF_2024-10-28%2013_10_15.440094/MSD_320_CV10_CorrFig_2024-10-28%2013_05_38.838566.png)
...
potData <- read_csv(file.path('Data', 'MSR3data32.csv'), col_types = 'cdd') %>% 
  slice_head(n = 6) %>% 
  gt() %>% 
  tab_header(title = 'Uploaded Data')
...
potCalcData <- read_csv(file.path(reports_dir, 'MSR3data32_POT_2024-10-28 13_03_06.293975', 'MSR3data32_POT_OutputData_tbl.csv'), col_types = 'cddddc') %>% 
  slice_head(n = 6) %>% 
  gt() %>% 
  tab_header(title = 'Calculated Data') %>% 
  fmt_scientific()
...
![Mean-Ratio plot of potency data.](Reports/MSR3data32_POT_2024-10-28%2013_03_06.293975/MSR3data32_MSRFig_2024-10-28%2013_02_38.772112.png){#fig-potMD}
...
potStats <- read_csv(file.path(reports_dir, 'MSR3data32_POT_2024-10-28 13_03_06.293975', 'MSR3data32_POT_Stats_tbl.csv'), col_types = 'cdddddd') %>% 
  gt() %>% 
...
![Potency Correlation plot.](Reports/MSD_320_CV10_EFF_2024-10-28%2013_10_15.440094/MSD_320_CV10_CorrFig_2024-10-28%2013_05_38.838566.png){#fig-potCorr}
...
![Mean Ratio plot.](Reports/FewSmplRep_POT_2024-10-28%2013_04_59.699411/FewSmpl_MSRFig_2024-10-28%2013_04_13.224078.png)

```{r}
#| label: tbl-fewSmplStats
#| tbl-cap: "Replicate Experiment Statistics"

fewSmplStats <- read_csv(file.path(reports_dir, 'FewSmplRep_POT_2024-10-28 13_04_59.699411/FewSmpl_POT_Stats_tbl.csv'), col_types = 'cdddddd') %>% 
  gt() %>% 
  tab_header(title = 'Potency Stats') %>% 
  fmt_scientific()
...
![Correlation Plot](Reports/FewSmplRep_POT_2024-10-28%2013_04_59.699411/FewSmpl_CorrFig_2024-10-28%2013_04_13.22479.png){#fig-fewCorr}
...
![Replicated samples Mean Ratio plot,](Reports/FewSmplRep_POT_2024-10-28%2013_04_59.699411/FewSmplRep_MSRFig_2024-10-28%2013_04_44.580655.png)
...
fewSmplRepStats <- read_csv(file.path(reports_dir, 'FewSmplRep_POT_2024-10-28 13_04_59.699411/FewSmplRep_POT_Stats_tbl.csv'), col_types = 'cdddddd') %>% 
  gt() %>% 
  tab_header(title = 'Potency Stats') %>% 
  fmt_scientific()
...
![Replicated samples correlation plot,](Reports/FewSmplRep_POT_2024-10-28%2013_04_59.699411/FewSmplRep_CorrFig_2024-10-28%2013_04_44.581414.png){#fig-repCorr}
...
potShiftStats <- read_csv(file.path(reports_dir, 'MSR3data32shift2_POT_2024-11-13 17_29_56.052133/MSR3data32shift2_POT_Stats_tbl.csv'), col_types = 'cdddddd') %>% 
  gt() %>% 
  tab_header(title = 'Potency Stats') %>% 
  fmt_scientific()
...
![Systematic error Correlation plot.](Reports/MSR3data32shift2_POT_2024-11-13%2017_29_56.052133/MSR3data32shift2_MSRFig_2024-11-13%2017_12_30.657818.png){#fig-seCorr}
...
![](Reports/MSR3data32shift2_POT_2024-11-13%2017_29_56.052133/MSR3data32shift2_CorrFig_2024-11-13%2017_12_30.658717.png)
